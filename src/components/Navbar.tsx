...
const activeButtonClasses = "text-gray-100 shadow-xl bg-red-600 px-3 py-2 rounded-md text-md font-medium";
const mobileActiveButtonClasses = "text-gray-100 shadow-xl bg-red-600 block px-3 py-2 rounded-md text-base font-medium";

const standardButtonClasses = "text-red-900 hover:bg-red-500 hover:text-white px-3 py-2 rounded-md text-md font-medium"
const mobileButtonClasses = "text-red-900 hover:bg-red-500 hover:text-white block px-3 py-2 rounded-md text-base font-medium"
...
const Navbar = () => {
    ...
    return (
        <nav className="bg-red-300 shadow-md dark:bg-gray-900">
                ...
                <div className="relative flex items-center justify-between h-16">
                    <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                        ...
                        <button onClick={(e: React.MouseEvent<HTMLButtonElement>) => setOpenMenu(!openMenu)} type="button" className="inline-flex items-center justify-center p-2 text-gray-400 rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
                            ...
                            <svg className="block w-6 h-6 text-2xl text-red-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                    ...
                    <div className="flex items-center justify-center flex-1 sm:items-stretch sm:justify-start">
                        <div className="flex items-center flex-shrink-0">
                            <a href="/" className="flex w-auto h-8 text-3xl text-red-900 lg:hidden"><AiOutlineCode /><span className='pl-1 text-2xl'>@atlc</span></a>
                            <a href="/" className="items-center hidden w-auto h-8 text-4xl text-red-900 lg:flex"><AiOutlineCode /><span className='pl-1 text-2xl'>@atlc</span></a>
                        </div>
                    ...
                    <div className="flex text-2xl dark:text-red-700">
